...
export default function MobileNav() {
  ...
  return (
    <div className="md:hidden bg-gradient-to-r from-primary to-accent w-full">
      <div className="flex items-center justify-between p-3 border-b border-white/10 shadow-md w-full">
        ...
        <h1 className="text-lg font-bold text-white">بنك الأمان</h1>

        <div className="flex items-center gap-2">
          <Button
            variant="ghost"
            size="icon"
            className="hover:bg-white/10 relative text-white rounded-full"
          >
            <Bell className="h-5 w-5" />
            <span className="absolute top-1 right-1 w-2 h-2 bg-secondary rounded-full"></span>
          </Button>
          <Avatar className="h-7 w-7 border border-white/20 shadow-md">
